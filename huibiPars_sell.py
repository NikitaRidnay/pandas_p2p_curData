...
def get_p2p_page_huobi_sell(crypto_currency):
    url = 'https://www.huobi.com/-/x/otc/v1/data/trade-market?coinId=2&currency=11&tradeType=buy&currPage=1&payMethod=36,29,28&acceptOrder=-1&country=&blockType=general&online=1&range=0&amount=&isThumbsUp=false&isMerchant=false&isTraded=false&onlyTradable=false&isFollowed=false'
